...
const UserScreen = (props) => {
  ...
  if (user) {
    ...
    if (user.budgetStart) budgetStart = user.budgetStart.toString();
    if (user.budgetEnd) budgetEnd = user.budgetEnd.toString();
  }
